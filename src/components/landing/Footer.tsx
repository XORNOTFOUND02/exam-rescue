        ...
        <div className="w-full md:w-1/2 flex flex-col justify-between p-10 sm:p-16">
          <div>
            ...
            <Link href="/onboarding">
              <motion.div
                className="inline-flex items-center gap-2.5 h-11 px-7 bg-white rounded-full text-black text-[13px] font-bold uppercase tracking-[0.06em] mt-8 cursor-pointer"
